    ...
    public partial class FindBySubjectController : ViewController
    {
        ...
        public FindBySubjectController()
        {
            ...
            ParametrizedAction findBySubjectAction = 
                new(this, "FindBySubjectAction", PredefinedCategory.View, typeof(string))
                {
                    ImageName = "Actin_Search",
                    NullValuePrompt = "Enter a subject to search for",
                
                };

            findBySubjectAction.Execute += FindBySubject_Execute;
        }


        private void FindBySubject_Execute(object sender, ParametrizedActionExecuteEventArgs e)
        {
